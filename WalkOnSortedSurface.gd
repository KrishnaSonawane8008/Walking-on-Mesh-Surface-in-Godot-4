...
func get_intersection_with_Segment(Face, MDT: MeshDataTool, Scale):
	var Face_Plane=Plane( (MDT.get_vertex(MDT.get_face_vertex(Face, 0)))*Scale, (MDT.get_vertex(MDT.get_face_vertex(Face, 1)))*Scale, (MDT.get_vertex(MDT.get_face_vertex(Face, 2)))*Scale )
